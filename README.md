...
- IP address: 34.222.128.48

- Accessible SSH port: 2200

- Application URL: http://ec2-34-222-128-48.us-west-2.compute.amazonaws.com
...
10. Clone the Catalog app from Github
  ...
  - `cd /catalog`
  - Clone your project from github `git clone {repository link} catalog`
...
17. Visit site at [http://34.222.128.48](http://34.222.128.48)
